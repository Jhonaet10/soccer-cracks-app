...
class RefereeHomeScreen extends ConsumerStatefulWidget {
  ...
  @override
  RefereeHomeScreenState createState() => RefereeHomeScreenState();
}

class RefereeHomeScreenState extends ConsumerState<RefereeHomeScreen> {
  @override
  void initState() {
    super.initState();
    _loadTournament();
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          elevation: 0,
          backgroundColor: RefereeHomeScreen.mainColor,
          title: Row(
            children: [
              CircleAvatar(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: RefereeHomeScreen.mainColor,
          ...
          bottom: const TabBar(
            tabs: [
              ...
              Tab(icon: Icon(Icons.edit_note), text: 'Resultados'),
            ],
        ...
        body: TabBarView(
          children: [
            ...
            // Tab de Partidos (con permisos de edición para árbitros)
            torneoState.selectedTorneo == null
                ? const Center(child: Text('No hay torneo asignado'))
                : const MatchesScreen(canEditResults: true),
            ...
            // Tab de Registro de Resultados
            torneoState.selectedTorneo == null
                ? const Center(child: Text('No hay torneo asignado'))
                : const RegisterResultsScreen(),
          ],
        ),
      ),
    );
